...
import { BroadcastEvent } from 'app/shared/models/broadcast-event'; import { BroadcastService } from './../../shared/services/broadcast.service';
...
import { Component, OnInit, EventEmitter, Input, ViewChild, SimpleChange, OnChanges, ComponentFactoryResolver, OnDestroy, Type } from '@angular/core';
