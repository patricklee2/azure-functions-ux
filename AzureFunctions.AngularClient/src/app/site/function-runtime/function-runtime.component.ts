...
export class FunctionRuntimeComponent implements OnDestroy {
    ...
    constructor(
        ...
        this._viewInfoSub = this._viewInfoStream
            ...
            .subscribe(r => {
                ...
                this._isSlotApp = this.site.name.indexOf("/") && this.site.type.indexOf("/slots") > 0
                ...
                //settings for enabling slots
                this.slotsAppSetting = appSettings.properties[Constants.slotsSecretStorageSettingsName];
                if (this._isSlotApp) {
                    this.slotsEnabled = true;
                } else {
                    this.slotsEnabled = this.slotsAppSetting && this.slotsAppSetting === Constants.slotsSecretStorageSettingsValue;
                }
            });
        ...
        this.slotsValueChange.subscribe((value: boolean) => {
            ...
            this._cacheService.postArm(`${this.site.id}/config/appsettings/list`, true)
                .flatMap(r => {
                    return this._setSlotsOptInEnabled(this.site, r.json(), slotsSettingsValue);
                })
                .subscribe(r => {
                    this.functionApp.fireSyncTrigger();
    ...
    private _setSlotsOptInEnabled(site: ArmObj<Site>, appSetting: ArmObj<any>, value?: string) {
